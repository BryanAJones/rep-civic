  ...
  return (
    <div className="right-rail">
      ...
      <div className="right-rail__item">
        <button className="right-rail__btn" type="button">
      ...
      {/* Questions */}
      <div className="right-rail__item">
        <button className="right-rail__btn" type="button" onClick={onQuestionsPress}>
          <svg viewBox="0 0 24 24">
      ...
      {/* Respond (gold) */}
      <div className="right-rail__item">
        <button className="right-rail__btn right-rail__btn--gold" type="button">
          <svg viewBox="0 0 24 24">
